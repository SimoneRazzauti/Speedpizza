  ...
  <div id="id02" class="modal1">
    ...
    <form class="modal-content1 animate" method="post" name="register" onsubmit="return validateFormRegister()" action="./utility/register.php">
      <div class="container1">
        ...
        <label><b>Username</b></label>
        <input type="text" placeholder="Inserisci Username" name="uname" class="modal1_input" id="modal1_username" required>
        ...
        <input type="text" placeholder="Inserisci Città" name="citta" class="modal1_input" id="modal1_citta" required>

        <label><b>Indirizzo</b></label>
        <input type="text" placeholder="Inserisci Indirizzo" name="indirizzo" class="modal1_input" id="modal1_indirizzo" required>
        ...
        <?php
        if (
          isset($_SESSION['emailErr']) || isset($_SESSION['emailErr']) || isset($_SESSION['nomeErr']) || isset($_SESSION['surnameErr']) || isset($_SESSION['usernameErr']) || isset($_SESSION['pswErr'])
