...
function template_menu() {
  echo '
    <nav class="topnav">
      <div class="menu-items">
        ...
        <a href="index.php#hr2" onclick="closeMenu()">Prenotazione</a>
  ...
  if(!isset($_SESSION["username"])){
    ...
    echo '
        <a onclick="openmodal2(); closeMenu();"><strong>' . $_SESSION["username"] . '</strong></a>';
  }
...
function footer_php() {
  ...
  <div class="contacts" id="footer">
    ...
    <div class="div-bottom">
      <p>&copy; ' . date('Y') . ' by Fastpizza Inc. All Rights Reserved.</p>
    </div>
  </div>
  ';
}
