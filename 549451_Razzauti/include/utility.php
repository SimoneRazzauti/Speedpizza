...
function template_menu() {
	...
	function template_menu_ADMIN() {
		...
		<ul class="menu__box">
		  <li><a class="menu__item" href="users.php">Home</a></li>
				<li><a class="menu__item" href="modificaRose.php">Modifica la rosa di un partecipante</a></li>
				<li><a class="menu__item" href="calcoloGiornata.php">Calcola una giornata</a></li>
				<li><a class="menu__item" href="logout.php">Logout</a></li>
		</ul>
	  </div>';
		}
