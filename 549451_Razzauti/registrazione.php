...
<label class="colonna">
	...
	<img src="immagini/eye.png" style="display: inline;"  width="15px" height="15px" onclick="rivelaC()">
<input type="password" name="confirmPassword" id="confirmPassword" value="" autocomplete="off" placeholder="conferma la password"  >
</label>
  </div>
