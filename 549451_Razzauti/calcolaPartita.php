...
<?php
    while ($squadraB = $squadraB_titolari->fetch()){
      ...
      echo "<td><label for='tb_rigSba_{$squadraB['idCalciatore']}'>Rigori Sbagliati: </label> <input type='text' id='tb_rigSba_{$squadraB['idCalciatore']}' name='tb_rigSba_{$squadraB['idCalciatore']}' value='0' size=1px/></td>\n";
...
?>
<a href='calcoloGiornata.php'>Torna indietro</a>
</body>
</html>
